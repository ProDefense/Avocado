...
"}")
        ...
        self.implants = QtWidgets.QTableView(self.centralwidget)
        self.implants.setGeometry(QtCore.QRect(20, 20, 491, 171))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.implants.sizePolicy().hasHeightForWidth())
        self.implants.setSizePolicy(sizePolicy)
